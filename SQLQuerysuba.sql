...
----31
alter view EMP_VIEWS 
As   
select E.ID,Frist_Name,E.Last_Name,D.DEPARTMENT_ID,D.DEPARTMENT_Name
from SUBHA_EMPLOYEES As E inner join   SUBHA_DEPARTMENTS as D on E.Department_id= D.DEPARTMENT_ID
...
----34
  ...
  alter procedure SUBHA_INSERT_VALUE  as
  begin 
  insert into SUBHA_DEPARTMENTS values (25,119,'Technical')
  end
  exec SUBHA_INSERT_VALUE 
  select*from SUBHA_DEPARTMENTS
---35
